...
class GestionStock:
    ...
    def setup_main_interface(self):
        ...
        # Disable certain tabs for normal users
        if self.current_user.rol != 'admin':
            self.notebook.tab(self.tab_usuarios, state='disabled')
            # Here you could also disable editing capabilities in other tabs
    ...
    def modificar_usuario(self, usuario_actual):
        # Here you could implement the logic for modifying users, 
        # ensuring only admins can modify roles or elevate permissions.
        pass
    ...
    # ... (other methods like cargar_datos, guardar_datos, etc.)
